...
if (hash["nick1"] == "" && hash["nick2"] == "") {
    document.getElementById("alerta").textContent = "Cadaster o jogar 1 e 2";
    
}if(hash["nick1"] == "" ){
    document.getElementById("jogador1").textContent = "Não á jogador";
    ocument.getElementById("alerta").textContent = "Cadaster o jogar 1";
    
}if(hash["nick2"] == ""){
     document.getElementById("jogador2").textContent = "Não á jogador";
    document.getElementById("alerta").textContent = "Cadaster o jogar 2";
}else {
    ...
    document.getElementById("btn-jogar1").style.display = "none";
    document.getElementById("btn-jogar2").style.display = "none";
...
function reinicarJogo(){
    ...
    document.getElementById("btn-jogar1").style.display = "inline-block";
    document.getElementById("btn-jogar2").style.display = "inline-block";
